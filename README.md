### ม็อดสำหรับเกมเวอร์ชัน open beta v1.9.2 [checksum: 41aa] 
### ฐานข้อมูลจาก Mod v0.90.7 beta </br>
</br>
...
วิธีติดตั้ง
 ...
 5. โหลดเกมตัว open beta ดังนี้ 
   ...
   5.2 คลิกขวาที่เกม จะมี Context menu แล้วเลือก Properties...
      <img src="docs/images/open_beta/beta_step1.png" width="100%">
   5.3 คลิก Tab BETAS
      <img src="docs/images/open_beta/beta_step2.png" width="100%">
   5.4 คลิก Drop-down เพื่อเลือกเกมเวอร์ชัน x.x.x_beta - codename (beta) ในที่นี้ให้เลือกเป็นเวอร์ชัน beta v1.9.2
      <img src="docs/images/open_beta/beta_step3.png" width="100%">
