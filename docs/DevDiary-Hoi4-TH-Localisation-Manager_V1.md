...
## ความรู้ที่ใช้
 ...
 - Docker -> Kubernetes (K8s) [Ver.1.0.1+]
...
- 4.ฝึกเป็นทักษะติดตัวไว้เพราะโลกต่อไปนี้ ระบบต่างๆจะรันบนคลาวด์ ซึ่งโปรแกรมนี้สามารถนำไปรันบน Google Cloud / AWS / Microsoft Azure ได้
