...
3. การอํานวยความสะดวกไขข้อความ เช่น เน้นคำสำคัญให้เด่นขึ้น (ใช้ข้อความสี) </br>
4. การพิมพ์ผิด </br>

นี่จึงเป็นการดีที่เราจะสร้างตัวแก้ไข (Localisation Editor) เพื้อแก้ปัญหาดังกล่าวและทำให้ระบบสมบูรณ์มากขึ้น</br>
...
5. เชื่อมต่อกับฐานข้อมูลโดยตรงได้ </br>
